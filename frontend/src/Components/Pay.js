        ...
        >
          ...
          >
            ...
            <Box sx={{ color: "#333333", fontSize: "0.9rem" }}>
              <Typography sx={{ mb: 2 }}>
                By proceeding with the payment, you have agreed to the following terms:
              </Typography>
              <ol>
                <li style={{ marginBottom: "10px" }}>
                  <strong>Partial Payment:</strong> If 25% of the amount is paid as a deposit, no refund will be provided in case of cancellation.
                </li>
                <li style={{ marginBottom: "10px" }}>
                  <strong>Full Payment:</strong> If full payment is made and cancellation occurs, 25% of the total amount will be deducted as a cancellation fee.
                </li>
                <li>
                  <strong>Punctuality:</strong> If you do not arrive at the scheduled time, the appointment will not be automatically canceled, and no refund will be provided.
                </li>
              </ol>
            </Box>
            <Button
