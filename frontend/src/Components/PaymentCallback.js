...
const PaymentCallback = () => {
  ...
  const generateReceiptPDF = () => {
    ...
    const terms = [
      "1. Partial Payment: If 25% of the amount is paid as a deposit, no refund will be provided in case of cancellation.",
      "2. Full Payment: If full payment is made and cancellation occurs, 25% of the total amount will be deducted as a cancellation fee.",
      "3. Punctuality: If you do not arrive at the scheduled time, the appointment will not be automatically canceled, and no refund will be provided.",
    ];
